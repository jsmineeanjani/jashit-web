    ...
    <div class="topbar-right">
        <div class="dropdown">
            <a href="#" class="user-dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                <?= htmlspecialchars($_SESSION['user_nama'] ?? 'Admin') ?> 
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 mt-2" style="border-radius: 8px;">
                <li>
                    <a class="dropdown-item py-2 text-secondary" href="<?= BASE_URL ?>/admin/pengaturan.php" style="font-size: 13.5px; font-weight: 500;">
                        <i class="bi bi-gear me-2"></i> Pengaturan Akun
                    </a>
                </li>
                <li><hr class="dropdown-divider"></li>
                <li>
                    <a href="#" class="dropdown-item py-2 text-danger" data-bs-toggle="modal" data-bs-target="#modalLogout" style="font-size: 13.5px; font-weight: 600;">
...
<style>
    ...
    .dropdown-menu { box-shadow: 0 10px 30px rgba(30,41,59,0.08) !important; min-width: 180px; }
    .dropdown-item:hover { background-color: #f8fafc; color: var(--navy-dark) !important; }
</style>
